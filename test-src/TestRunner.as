package
{
	import test.net.sfmultimedia.argonaut.ArgonautTest;
	import test.net.sfmultimedia.argonaut.JSONEncoderTest;
	import test.net.sfmultimedia.argonaut.ClassRegisterTest;
	import test.net.sfmultimedia.argonaut.JSONDecoderTest;
	...
	public class TestRunner extends Sprite 
	{
		...
		public function TestRunner() 
		{
			...
			//core.run( request );
			core.run(ArgonautTest, ClassRegisterTest, JSONDecoderTest, JSONEncoderTest);
		}
	}
}
